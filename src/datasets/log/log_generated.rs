...
impl<'a> ::flatbuffers::Follow<'a> for Address {
  ...
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    unsafe { <&'a Address>::follow(buf, loc) }
  }
}
impl<'a> ::flatbuffers::Follow<'a> for &'a Address {
  ...
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    unsafe { ::flatbuffers::follow_cast_ref::<Address>(buf, loc) }
  }
}
impl<'b> ::flatbuffers::Push for Address {
    ...
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = unsafe { ::core::slice::from_raw_parts(self as *const Address as *const u8, <Self as ::flatbuffers::Push>::size()) };
