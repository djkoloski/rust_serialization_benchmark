...
pub mod mk_48 {
    ...
    impl<'a> Transform {
        #[allow(clippy::too_many_arguments)]
        pub fn new(altitude: i8, angle: u16, position: &Vector2f, velocity: i16) -> Self {
            let mut s = Self([0; 16]);
    ...
    impl<'b> flatbuffers::Push for Guidance {
        ...
        unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
            let src =
                ::core::slice::from_raw_parts(self as *const Guidance as *const u8, Self::size());
            dst.copy_from_slice(src);
        }
    }
    ...
    impl<'a> Guidance {
        #[allow(clippy::too_many_arguments)]
        pub fn new(angle: u16, submerge: bool, velocity: i16) -> Self {
            let mut s = Self([0; 6]);
            s.set_angle(angle);
    ...
    impl<'b> flatbuffers::Push for ChunkId {
        ...
        unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
            let src =
                ::core::slice::from_raw_parts(self as *const ChunkId as *const u8, Self::size());
            dst.copy_from_slice(src);
        }
    }
    ...
    impl<'a> Update<'a> {
        ...
        pub fn terrain_updates(
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TerrainUpdate>>,
    ...
    impl flatbuffers::Verifiable for Update<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                >>("contacts", Self::VT_CONTACTS, true)?
                .visit_field::<u32>("score", Self::VT_SCORE, false)?
                .visit_field::<f32>("world_radius", Self::VT_WORLD_RADIUS, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<TerrainUpdate>>,
                >>("terrain_updates", Self::VT_TERRAIN_UPDATES, true)?
                .finish();
            Ok(())
        }
    }
