...
pub mod minecraft_savedata {
    ...
    impl<'a> Vehicle<'a> {
        ...
        pub fn entity(&self) -> Entity<'a> {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<Entity>>(Vehicle::VT_ENTITY, None)
                .unwrap()
        }
    }
    ...
    impl flatbuffers::Verifiable for Vehicle<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                .visit_field::<flatbuffers::ForwardsUOffset<Entity>>(
                    &"entity",
                    Self::VT_ENTITY,
                    true,
                )?
    ...
    impl<'a> Player<'a> {
        ...
        pub fn selected_item(&self) -> Item<'a> {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<Item>>(Player::VT_SELECTED_ITEM, None)
                .unwrap()
        }
        #[inline]
        ...
        pub fn inventory(&self) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Item<'a>>> {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Item>>,
        ...
        pub fn root_vehicle(&self) -> Option<Vehicle<'a>> {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<Vehicle>>(Player::VT_ROOT_VEHICLE, None)
        }
        #[inline]
        pub fn shoulder_entity_left(&self) -> Option<Entity<'a>> {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<Entity>>(Player::VT_SHOULDER_ENTITY_LEFT, None)
        }
        #[inline]
        pub fn shoulder_entity_right(&self) -> Option<Entity<'a>> {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<Entity>>(Player::VT_SHOULDER_ENTITY_RIGHT, None)
        }
        #[inline]
        ...
        pub fn recipe_book(&self) -> RecipeBook<'a> {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<RecipeBook>>(Player::VT_RECIPE_BOOK, None)
                .unwrap()
        }
    }
    ...
    impl flatbuffers::Verifiable for Player<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                .visit_field::<flatbuffers::ForwardsUOffset<Item>>(
                    &"selected_item",
                    Self::VT_SELECTED_ITEM,
                    true,
                )?
                .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                    &"spawn_dimension",
                    Self::VT_SPAWN_DIMENSION,
                    false,
                )?
                ...
                .visit_field::<f32>(
                    ...
                    Self::VT_FOOD_EXHAUSTION_LEVEL,
                    false,
                )?
                .visit_field::<f32>(
                    &"food_saturation_level",
                    Self::VT_FOOD_SATURATION_LEVEL,
                    false,
                )?
                ...
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Item>>,
                >>(&"inventory", Self::VT_INVENTORY, true)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Item>>,
                >>(&"ender_items", Self::VT_ENDER_ITEMS, true)?
                .visit_field::<Abilities>(&"abilities", Self::VT_ABILITIES, true)?
                .visit_field::<Vector3d>(
                    &"entered_nether_position",
                    Self::VT_ENTERED_NETHER_POSITION,
                    false,
                )?
                .visit_field::<flatbuffers::ForwardsUOffset<Vehicle>>(
                    &"root_vehicle",
                    Self::VT_ROOT_VEHICLE,
                    false,
                )?
                .visit_field::<flatbuffers::ForwardsUOffset<Entity>>(
                    &"shoulder_entity_left",
                    Self::VT_SHOULDER_ENTITY_LEFT,
                    false,
                )?
                .visit_field::<flatbuffers::ForwardsUOffset<Entity>>(
                    &"shoulder_entity_right",
                    Self::VT_SHOULDER_ENTITY_RIGHT,
                    false,
                )?
                .visit_field::<bool>(&"seen_credits", Self::VT_SEEN_CREDITS, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<RecipeBook>>(
                    &"recipe_book",
                    Self::VT_RECIPE_BOOK,
                    true,
                )?
    ...
    impl<'a> Players<'a> {
        ...
        pub fn players(&self) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Player<'a>>> {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Player>>,
    ...
    impl flatbuffers::Verifiable for Players<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Player>>,
                >>(&"players", Self::VT_PLAYERS, true)?
                .finish();
            Ok(())
        }
    }
