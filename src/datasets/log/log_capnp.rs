...
pub mod address {
    ...
    mod _private {
        ...
        pub(crate) const TYPE_ID: u64 = 0x96d2_eb22_6a8b_d47a;
    }
}
...
pub mod log {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 125] = [
            ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
        ...
        pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
        pub(crate) static MEMBERS_BY_NAME : &[u16] = &[0,5,3,1,4,6,2];
        pub(crate) const TYPE_ID: u64 = 0x87f6_c7ab_2de3_81ff;
    }
}
...
pub mod logs {
    ...
    mod _private {
        ...
        pub(crate) const TYPE_ID: u64 = 0x9658_6a57_8e4a_5409;
    }
}
