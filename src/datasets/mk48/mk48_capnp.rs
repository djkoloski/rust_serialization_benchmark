...
impl ::capnp::introspect::Introspect for EntityType {
    fn introspect() -> ::capnp::introspect::Type { ::capnp::introspect::TypeVariant::Enum(::capnp::introspect::RawEnumSchema::new(&entity_type::ARENA, entity_type::get_annotation_types)).into() }
}
impl ::core::convert::From<EntityType> for ::capnp::dynamic_value::Reader<'_> {
    fn from(e: EntityType) -> Self { ::capnp::dynamic_value::Enum::new(e.into(), ::capnp::introspect::RawEnumSchema::new(&entity_type::ARENA, entity_type::get_annotation_types).into()).into() }
}
...
pub mod transform {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 76] = [
            ...
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(196, 0, 0, 0, 103, 1, 0, 0),
        ...
        pub(crate) const TYPE_ID: u64 = 0xf3a9_5b0d_39e0_d8cf;
    }
    ...
    pub mod position {
        ...
        mod _private {
            ...
            pub(crate) const TYPE_ID: u64 = 0xb3c9_5ba2_b9a3_c5a8;
        }
    }
}
...
pub mod guidance {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 67] = [
            ...
            ::capnp::word(0, 0, 7, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(105, 1, 0, 0, 193, 1, 0, 0),
        ...
        pub(crate) const TYPE_ID: u64 = 0xd7ae_1d3b_a67e_97c7;
    }
}
...
pub mod contact {
    ...
    mod _private {
        ...
        pub(crate) const TYPE_ID: u64 = 0x826a_86d1_5bac_3821;
    }
    ...
    pub mod entity_type {
        ...
        mod _private {
            ...
            pub(crate) static MEMBERS_BY_NAME : &[u16] = &[0,1];
            pub(crate) const TYPE_ID: u64 = 0xacb0_b840_1e98_1430;
        }
        pub enum Which {
            None(()),
    ...
    pub mod player_id {
        ...
        mod _private {
            ...
            pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[0,1];
            pub(crate) static MEMBERS_BY_NAME : &[u16] = &[0,1];
            pub(crate) const TYPE_ID: u64 = 0xf63a_4a8e_d2d2_6914;
        }
        pub enum Which {
            None(()),
            Some(u16),
...
pub mod terrain_update {
    ...
    mod _private {
        ...
        pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
        pub(crate) static MEMBERS_BY_NAME : &[u16] = &[0,1];
        pub(crate) const TYPE_ID: u64 = 0xc58e_d9f7_e9d1_663c;
    }
    ...
    pub mod chunk_id {
        ...
        mod _private {
            ...
            pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
            pub(crate) static MEMBERS_BY_NAME : &[u16] = &[0,1];
            pub(crate) const TYPE_ID: u64 = 0xa85b_f3b5_3fbc_321c;
        }
    }
}
...
pub mod update {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 91] = [
            ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
        ...
        pub(crate) const TYPE_ID: u64 = 0xfbfa_451d_8326_0a33;
    }
}
...
pub mod updates {
    ...
    mod _private {
        ...
        pub(crate) const TYPE_ID: u64 = 0xfa45_0c67_fb5e_63d3;
    }
}
