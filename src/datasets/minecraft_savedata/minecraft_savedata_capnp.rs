...
impl ::capnp::introspect::Introspect for GameType {
    fn introspect() -> ::capnp::introspect::Type { ::capnp::introspect::TypeVariant::Enum(::capnp::introspect::RawEnumSchema::new(&game_type::ARENA, game_type::get_annotation_types)).into() }
}
impl ::core::convert::From<GameType> for ::capnp::dynamic_value::Reader<'_> {
    fn from(e: GameType) -> Self { ::capnp::dynamic_value::Enum::new(e.into(), ::capnp::introspect::RawEnumSchema::new(&game_type::ARENA, game_type::get_annotation_types).into()).into() }
}
...
pub mod item {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 68] = [
            ...
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(111, 0, 0, 0, 183, 0, 0, 0),
        ...
        pub(crate) const TYPE_ID: u64 = 0xe80c_a65e_fefd_a456;
    }
}
...
pub mod abilities {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 134] = [
            ...
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(185, 0, 0, 0, 119, 1, 0, 0),
        ...
        pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
        pub(crate) static MEMBERS_BY_NAME : &[u16] = &[1,3,6,4,5,2,0];
        pub(crate) const TYPE_ID: u64 = 0xeb01_bb9a_c273_82d1;
    }
}
...
pub mod entity {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 244] = [
            ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
        ...
        pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
        pub(crate) static MEMBERS_BY_NAME : &[u16] = &[6,12,13,4,5,15,0,9,2,8,7,10,1,3,14,11];
        pub(crate) const TYPE_ID: u64 = 0xa4c4_298d_a569_4821;
    }
    ...
    pub mod pos {
        ...
        mod _private {
            ...
            pub(crate) const TYPE_ID: u64 = 0xdef3_1493_9643_0df6;
        }
    }
    ...
    pub mod motion {
        ...
        mod _private {
            ...
            pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
            pub(crate) static MEMBERS_BY_NAME : &[u16] = &[0,1,2];
            pub(crate) const TYPE_ID: u64 = 0xf03a_4aba_cc0e_9775;
        }
    }
    ...
    pub mod rotation {
        ...
        mod _private {
            ...
            pub(crate) const TYPE_ID: u64 = 0xa1f6_5b5d_e1f5_56a5;
        }
    }
    ...
    pub mod uuid {
        ...
        mod _private {
            ...
            pub(crate) const TYPE_ID: u64 = 0x8202_c2ce_fb09_919d;
        }
    }
}
...
pub mod recipe_book {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 202] = [
            ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
        ...
        pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
        pub(crate) static MEMBERS_BY_NAME : &[u16] = &[6,7,2,4,5,3,8,9,0,1];
        pub(crate) const TYPE_ID: u64 = 0xc784_ef71_75eb_6eb4;
    }
}
...
pub mod player {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 399] = [
            ...
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(176, 5, 0, 0, 98, 11, 0, 0),
            ::capnp::word(21, 0, 0, 0, 2, 2, 0, 0),
            ::capnp::word(49, 0, 0, 0, 7, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ...
        pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
        pub(crate) static MEMBERS_BY_NAME : &[u16] = &[19,3,18,20,10,11,12,0,17,1,25,21,2,24,5,4,22,23,9,7,6,8,13,14,16,15];
        pub(crate) const TYPE_ID: u64 = 0xae91_5b4d_6e13_f034;
    }
    ...
    pub mod spawn_dimension {
        ...
        mod _private {
            ...
            pub(crate) static MEMBERS_BY_NAME : &[u16] = &[0,1];
            pub(crate) const TYPE_ID: u64 = 0xab4e_4173_a401_c9aa;
        }
        pub enum Which<A0> {
            None(()),
            Some(A0),
    ...
    pub mod spawn {
        ...
        mod _private {
            ...
            pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
            pub(crate) static MEMBERS_BY_NAME : &[u16] = &[0,1,2];
            pub(crate) const TYPE_ID: u64 = 0xb9d8_f3d9_6715_bb8e;
        }
    }
    ...
    pub mod spawn_forced {
        ...
        mod _private {
            ...
            pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[0,1];
            pub(crate) static MEMBERS_BY_NAME : &[u16] = &[0,1];
            pub(crate) const TYPE_ID: u64 = 0xca08_8848_7d66_f2df;
        }
        pub enum Which {
            None(()),
            Some(bool),
    ...
    pub mod entered_nether_position {
        ...
        mod _private {
            ...
            pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[0,1];
            pub(crate) static MEMBERS_BY_NAME : &[u16] = &[0,1];
            pub(crate) const TYPE_ID: u64 = 0x96c0_bbb4_3e82_1237;
        }
        pub enum Which<A0> {
            None(()),
            Some(A0),
        ...
        pub mod some {
            ...
            mod _private {
                ...
                pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
                pub(crate) static MEMBERS_BY_NAME : &[u16] = &[0,1,2];
                pub(crate) const TYPE_ID: u64 = 0xc6af_15d4_c5e6_38b7;
            }
        }
    }
    ...
    pub mod root_vehicle {
        ...
        mod _private {
            ...
            pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[0,1];
            pub(crate) static MEMBERS_BY_NAME : &[u16] = &[0,1];
            pub(crate) const TYPE_ID: u64 = 0xe1ce_566d_6b19_8fb5;
        }
        pub enum Which<A0> {
            None(()),
            Some(A0),
        ...
        pub mod some {
            ...
            mod _private {
                ...
                pub(crate) const TYPE_ID: u64 = 0xbb13_5874_77e1_a14b;
            }
            ...
            pub mod uuid {
                ...
                mod _private {
                    ...
                    pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
                    pub(crate) static MEMBERS_BY_NAME : &[u16] = &[0,1,2,3];
                    pub(crate) const TYPE_ID: u64 = 0x83b8_f3d5_b8e1_61dd;
                }
            }
        }
    }
    ...
    pub mod shoulder_entity_left {
        ...
        mod _private {
            ...
            pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[0,1];
            pub(crate) static MEMBERS_BY_NAME : &[u16] = &[0,1];
            pub(crate) const TYPE_ID: u64 = 0xf770_22cb_2838_521d;
        }
        pub enum Which<A0> {
            None(()),
            Some(A0),
    ...
    pub mod shoulder_entity_right {
        ...
        mod _private {
            ...
            pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[0,1];
            pub(crate) static MEMBERS_BY_NAME : &[u16] = &[0,1];
            pub(crate) const TYPE_ID: u64 = 0x8bc9_8a23_c654_611c;
        }
        pub enum Which<A0> {
            None(()),
            Some(A0),
...
pub mod players {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 43] = [
            ...
            ::capnp::word(1, 0, 7, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(100, 11, 0, 0, 148, 11, 0, 0),
        ...
        pub(crate) const TYPE_ID: u64 = 0x9a2e_339d_0113_73c2;
    }
}
